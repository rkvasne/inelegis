  ...
  function renderHeader(currentPage = "") {
    ...
    const termosAceitos =
      (typeof window !== "undefined" &&
        ...
        window.SecureStorage.getItem("termos_aceitos") === true) ||
    ...
    const navLinks = pages
      .map((page) => {
        ...
        const disabledAttr = isDisabled
          ? " aria-disabled=\"true\" onclick=\"event.preventDefault(); if(window.showCheckboxArrow) { window.showCheckboxArrow(); } else { sessionStorage.setItem('ineleg_redirect_reason', 'terms_not_accepted'); window.location.href='./'; }\""
          : "";
                ...
                <div class="${wrapperClass}">
                    <div class="system-brand">
                        ...
                        <div class="brand-text">
                            <h1>Inelegis <span class="version-badge">v0.3.7</span></h1>
                    ...
                    <div class="header-actions">
                        <button id="themeToggle" class="theme-toggle" aria-label="Alternar tema" title="Alternar tema">
                            ...
                            <svg class="moon-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.0.3.7 0012 21a9.003 9.0.3.7 008.354-5.646z"></path>
                            </svg>
                        </button>
                    </div>
                </div>
