...
| Função                         | Descrição                                                                                                                                                                                                                         |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `verificar_elegibilidade()`    | RPC base (compatibilidade) conforme [interpretação da tabela CRE](../references/interpretacao-tabela-oficial.md), com normalização defensiva de `p_paragrafo` (`caput`/`único`) e fail-safe contra lacuna estrutural de exceções. |
