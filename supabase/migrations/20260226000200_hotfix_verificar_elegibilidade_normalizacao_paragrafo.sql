-- =====================================================
-- Migration: hotfix verificar_elegibilidade (normalizacao p_paragrafo)
-- =====================================================
-- Objetivo:
-- - Eliminar mismatch semantico no backend para entradas de paragrafo
--   como "caput", "unico"/"unico" com acento, "§", ordinais e variacoes.
...
COMMENT ON FUNCTION public.verificar_elegibilidade IS 'Hotfix 20260226000200: normalizacao robusta de p_paragrafo (caput/unico/simbolos/acentos) na RPC base.';
