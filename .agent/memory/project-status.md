...
- 11/02/2026 (Checkpoint 2 - **v0.3.8**): **Security & Sanity Extraction.** Introdução de filtros de sanidade no Analisador para evitar falsos positivos de extração. Implementação de ajuda contextual (Dicas de Formato) e avisos Toasts instrutivos. Refinamento da Regex jurídica para parágrafos complexos. Projeto 100% CONFORME após `npm run verify`.
