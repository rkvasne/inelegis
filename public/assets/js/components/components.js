                ...
                <div class="${wrapperClass}">
                    <div class="system-brand">
                        ...
                        <div class="brand-text">
                            <h1>Inelegis <span class="version-badge">v0.3.12</span></h1>
                    ...
                    <div class="header-actions">
                        <button id="themeToggle" class="theme-toggle" aria-label="Alternar tema" title="Alternar tema">
                            ...
                            <svg class="moon-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 00 21a9.003 9.003 0 008.354-5.646z"></path>
                            </svg>
                        </button>
                    </div>
                </div>
